...
function updateInformationStatus(){
    ...
    var early_rate    = $("#early_rate").val();
    var after_rate    = $("#after_rate").val();
    var onsite_rate    = $("#onsite_rate").val();
   $.ajax({
                url:url+"/editstatus/"+id,
                type:"POST",
                data:'{"status_name":"'+status_name+'","early_rate":"'+early_rate+'","after_rate":"'+after_rate+'","onsite_rate":"'+onsite_rate+'"}',
